...
Widget::Widget(QWidget *parent) : QWidget(parent) {
    ...
    gridLayout->addWidget(line0_Label,0,5);
    gridLayout->addWidget(back00_Label,0,6);
    gridLayout->addWidget(back01_Label,0,7);
    ...
    gridLayout->addWidget(line1_Label,1,5);
    gridLayout->addWidget(back10_Label,1,6);
    gridLayout->addWidget(back11_Label,1,7);
    ...
    gridLayout->addWidget(line2_Label,2,5);
    gridLayout->addWidget(back20_Label,2,6);
    gridLayout->addWidget(back21_Label,2,7);
    ...
    gridLayout->addWidget(line3_Label,3,5);
    gridLayout->addWidget(back30_Label,3,6);
    gridLayout->addWidget(back31_Label,3,7);
    ...
    gridLayout->addWidget(line4_Label,4,5);
    gridLayout->addWidget(back40_Label,4,6);
    gridLayout->addWidget(back41_Label,4,7);
...
void Widget::Click_shuffle_Button() {
    ...
    shuffleArray(frontArr,35);
    shuffleArray(backArr,12);
    ...
    back01_Label->setText(QString("%1").arg(backArr[1], 2, 10, QChar('0')));
    ...
    back11_Label->setText(QString("%1").arg(backArr[3], 2, 10, QChar('0')));
    ...
    back21_Label->setText(QString("%1").arg(backArr[5], 2, 10, QChar('0')));
    ...
    back31_Label->setText(QString("%1").arg(backArr[7], 2, 10, QChar('0')));
    ...
    back41_Label->setText(QString("%1").arg(backArr[9], 2, 10, QChar('0')));
}
